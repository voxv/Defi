    ...
    socket.on('message', (message) => {
        ...
        switch (data.type) {
            ...
            case 'inGameConfirm':
    			...
    			reinit(players[socket.player.state.id].state)
                break;
            ...
            case 'drawDoneConfirm':
                if (socket.player.state.id == 'player1' && players[socket.player.state.id].state.cards.length == 0) {
                    ...
                    console.log('DRAWDONE P1 left:'+players['player1'].state.cards.length)
                    console.log('DRAWDONE P2 left:'+players['player2'].state.cards.length)
                }
            ...
            case 'drawWinnerShown':
                ...
                if (players['player1'].state.drawWinnerShown && players['player2'].state.drawWinnerShown) {
                    ...
                    console.log('drawWinnerShown P1 left:'+players['player1'].state.cards.length)
                    console.log('drawWinnerShown P2 left:'+players['player2'].state.cards.length)
                break
            ...
            case 'playedCard':
                ...
                console.log('playeCardP1:'+players['player1'].state.playedCard)
                console.log('playeCardP2:'+players['player2'].state.playedCard)
                if (players['player1'].state.playedCard && players['player2'].state.playedCard) {
					console.log('sending playedCardFinish')
                    sendToAll({
                        type: 'playedCardFinish',
                        caller: socket.player.state.id
                    })
                }
                    console.log('playedCard P1 left:'+players['player1'].state.cards.length)
                    console.log('playedCard P2 left:'+players['player2'].state.cards.length)
                players['player1'].state.finishedChoiceAnim = false
                players['player2'].state.finishedChoiceAnim = false
                players['player1'].state.showColOverrideDone = false
                players['player2'].state.showColOverrideDone = false
                break
            ...
            case 'attrResults':
                ...
                if (players['player1'].state.attrResultsFound && players['player2'].state.attrResultsFound) {
                    ...
                    if (!colOverrideSent && colOverride) {
                     ...
                     console.log('attrResults P1 left:'+players['player1'].state.cards.length)
                    console.log('attrResults P2 left:'+players['player2'].state.cards.length)
                break
            ...
            case 'showAttrValsDone':
                ...
                if (players['player1'].state.showAttrValsDone && players['player2'].state.showAttrValsDone) {
                    sendToAll({
                     ...
                     console.log('showAttrValsDone P1 left:'+players['player1'].state.cards.length)
                    console.log('showAttrValsDone P2 left:'+players['player2'].state.cards.length)
                break
            ...
            case 'playCardAttackDone':
                ...
                if (players['player1'].state.playCardAttackDone && players['player2'].state.playCardAttackDone) {
                    sendToAll({
                     ...
                     console.log('playCardAttackDone P1 left:'+players['player1'].state.cards.length)
                    console.log('playCardAttackDone P2 left:'+players['player2'].state.cards.length)
                break
            case 'readyNextTurn':
                if (socket.player.state.id == 'player1') {
                    ...
                    if (data.winner == 'player1') {
                     ...
                     console.log('readyNextTurn P1 left:'+players['player1'].state.cards.length)
                    console.log('readyNextTurn P2 left:'+players['player2'].state.cards.length)
                    console.log('cardsPlayedP1 '+cardsPlayedP1.length)
                    console.log('cardsPlayedP2 '+cardsPlayedP2.length)
                ...
                if (players['player1'].state.readyNextTurn && players['player2'].state.readyNextTurn) {
                    ...
                    players['player1'].state.playedCard = false
                    players['player2'].state.playedCard = false
                    colOverrideSent = false
                    var gameover = false
                    ...
                    console.log('gameOverTimeout:'+gameOverTimeout)
                    console.log('lp1: '+players['player1'].state.cards.length)
                    console.log('lp2: '+players['player2'].state.cards.length)
                    if (gameOverTimeout || players['player1'].state.cards.length == 0 && cardsPlayedP1.length == 0 || players['player2'].state.cards.length == 0 && cardsPlayedP2.length == 0) {
						...
						console.log('diffInSeconds:'+diffInSeconds+' > '+gameMaxLength+' ?')
